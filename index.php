<html>
    <body>
        <a href="hardware.php">hardware.php</a> <br />
        <a href="hardware_inline.php">hardware_inline.php</a> <br />
        <a href="hardware_toevoegen.php">hardware_toevoegen.php</a> <br />
        <a href="software.php">software.php</a> <br />
        <a href="software_inline.php">software_inline.php</a> <br />
